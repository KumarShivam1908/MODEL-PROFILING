import os
import asyncio
from ModelWrappers.Pytorch_Wrapper import Classifier
from ModelWrappers.Onnx_Wrapper import OnnxWrapper
from ModelWrappers.TensorRT_Wrapper import TensorRTWrapper
...
async def main():
    ...
    results_df = profiler.run_complete_profile(
        pytorch_path='assets/pt_model.pth',
        onnx_path='assets/model.onnx',
        tensorrt_path='assets/model.trt'
    )
